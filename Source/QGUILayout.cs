...
namespace QFSW.QGUI
{
    ...
    {
        public static T EnumPopup<T>(T selected, params GUILayoutOption[] options) where T : struct, Enum
        {
            return (T)EditorGUILayout.EnumPopup(selected, options);
        }

        public static T EnumPopup<T>(GUIContent content, T selected, params GUILayoutOption[] options) where T : struct, Enum
        {
            return (T)EditorGUILayout.EnumPopup(content, selected, options);
        }

        public static T EnumFlagsField<T>(GUIContent content, T enumValue, params GUILayoutOption[] options) where T : struct, Enum
        {
